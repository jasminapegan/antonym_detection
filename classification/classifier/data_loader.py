...
class AntSynProcessor(object):
    """Processor for the ant/syn data set """
    ...
    def _read_tsv(cls, input_file, quotechar=None):
        ...
        with open(input_file, "r", encoding="utf-8") as f:
            ...
            for line in reader:
                w1, pos1, form1, sense1, idx1, s1, w2, pos2, form2, sense2, idx2, s2, label = line
...
processors = {"ant": AntSynProcessor, "syn": AntSynProcessor}
